...
| 3 | [Run transaction](/use/tools/run-transaction) | Prague + `authorizationList`; read `returnValue` / gas |
...
<Changelog
  ...
  :entries="[
    { date: '2026-03-26', note: 'Runnable run_transaction + inspect authorization-list on Prague.' },
  ]"
/>
