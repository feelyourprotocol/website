...
> **Status:** **Runnable locally** (stdio v0.1, self-hosted). **Public MCP not launched yet** — use the [website exploration](https://feelyourprotocol.org/eip-8024-stack-opcodes-dupn-swapn-exchange) today.
