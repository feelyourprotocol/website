...
4. Update `use/coverage.md` (the human EIP index). Do **not** add per-EIP rows to the VitePress sidebar. Landing on mainnet does **not** remove the twin; keep it on Coverage and the fork page.
