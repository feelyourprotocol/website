...
Load and follow [add-exploration](../add-exploration/SKILL.md). **Plan and implement in one go** (design is not a separate human gate). Branches: human creates `eip-NNNN` or gives explicit git instructions — do not auto checkout across siblings.
