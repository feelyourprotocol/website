...
- **Weather briefing** — what is moving in Ethereum protocol (always-on “what moved” survey plus one rotating corner) and high-stakes MCP (Base when it clears the bar); one link per story, not every quote in the thread
