...
export const CANONICAL: ProtocolChangeCanonical = {
  ...
  mcp: {
    ...
    comparison: {
      ...
      note: 'Value call to empty account: Amsterdam gasUsed includes ~183600 state-creation gas; Osaka does not. Widget uses a full tx so 21000 vs recommended gasLimit is visible.',
    },
    docsStatus: 'runnable',
  },
}
